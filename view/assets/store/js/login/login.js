$(function () {
        ...
        if (tab == 'account_number') {
            $(".log-btn").click(function () {
                ...
                if (checkAccount(inp) && checkPass(pass)) {
                    ...
                    $.ajax({
                        url: '/auth/oauth/token?code=' + $("#veri").val() + '&randomStr=' + randomCode,
                        type: 'post',
                        headers: {
    ...
    function refreshCode() {
        randomCode = Math.random() * 100000000000000000
        // randomCode = 74382852591906400
        $("#veri-sign").attr('src', 'http://120.78.142.62:9999/code?randomStr=' + randomCode)
    }
